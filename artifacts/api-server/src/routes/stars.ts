...
const STARS_CATALOG: StarsItem[] = [
  ...
  { id: "white_collection", title: "White Collection Limited", description: "Unlock 4 exclusive farm slots. Yield: 3.3 TON / month. Requires SUN module.", starsPrice: 2000, tonPrice: 20, itemType: "white_collection" },
