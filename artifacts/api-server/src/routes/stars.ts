...
const STARS_CATALOG: StarsItem[] = [
  ...
  { id: "white_collection", title: "White Collection Limited", description: "Unlock 4 exclusive farm slots. Yield: ~0.44 TON / month (~0.11 TON / day). Requires SUN module.", starsPrice: 2000, tonPrice: 20, itemType: "white_collection" },
  ...
  { id: "earth_collection", title: "Earth Collection Limited", description: "Unlock 4 exclusive earth planets. Yield: ~0.51 TON / month (~0.017 TON / day). Requires SUN module.", starsPrice: 700, tonPrice: 5, itemType: "earth_collection" },
