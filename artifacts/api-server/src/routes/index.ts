...
import labFuseRouter from "./lab-fuse";
...
const PROTECTED_ROUTES: ProtectedRoute[] = [
  ...
  // can't impersonate an admin AND can't pass the admin allow-list check).
  {
    ...
    paths: [
      ...
      "/admin/grant-studio-badge",
      "/admin/studio-gallery/hide",
      "/admin/studio-gallery/restore",
