...
import { hasTreasurySigner, treasuryEnvKeyNames, treasuryMnemonicWordCount } from "./lib/zmc";
...
server.listen(port, () => {
  logger.info({
    port,
    treasurySigner: hasTreasurySigner(),
    treasuryWordCount: treasuryMnemonicWordCount(),
    treasuryEnvKeys: treasuryEnvKeyNames(),
  }, "Server listening");
