    ...
    >
      <div style={{
        ...
        <div style={{
          ...
          The ZOOM Store is launching soon.{"\n"}Pay with $ZOOM and flex the movement.
        </div>
        <div style={{
      ...
      {open && (
        <div
          ...
          style={{
            ...
            padding: "calc(env(safe-area-inset-top, 0px) + 100px) 14px calc(env(safe-area-inset-bottom, 0px) + 80px)",
            overflowY: "auto",
          }}
        >
          <div style={{
            ...
            <div style={{ position: "relative", width: "100%", aspectRatio: "2/1", overflow: "hidden" }}>
              ...
              <div style={{
                ...
                background: "linear-gradient(to bottom, rgba(0,0,0,0.1) 40%, rgba(8,6,0,0.98) 100%)",
              }} />
              {/* Title on hero */}
              <div style={{
            ...
            <div style={{ padding: "14px 14px 20px" }}>
                ...
                {PRODUCTS.map((p) => (
                  <div
                    ...
                    style={{
                      ...
                      border: `1px solid ${STORE_GOLD}22`,
                    ...
                    <div style={{
                      ...
                      <button
                        ...
                        style={{
                          ...
                          fontWeight: 800, fontSize: 9, letterSpacing: "0.08em",
                          background: `linear-gradient(135deg, ${STORE_GOLD}cc, #e6a800cc)`,
                          border: `1px solid ${STORE_GLOW}88`,
                          color: "#1a1000", cursor: "pointer",
                          boxShadow: `0 0 12px ${STORE_GOLD}33`,
                          whiteSpace: "nowrap",
                        }}
                      >
                        🛒 BUY
              ...
              <div style={{
                ...
                fontSize: 8, color: "rgba(255,215,0,0.3)",
                lineHeight: 1.6, letterSpacing: "0.06em",
              }}>
                🔒 Secure checkout · All orders verified on-chain{"\n"}
