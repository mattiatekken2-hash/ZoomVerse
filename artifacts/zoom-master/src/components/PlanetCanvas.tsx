    ...
    <div ref={containerRef} className="relative w-full h-full flex flex-col items-center justify-center overflow-hidden">
      ...
      >
        ...
        {showCoreAndOrbits && (
          ...
          >
            {orbitParticles.a.map((p, i) => {
              const dotSize = Math.max(6, size * 0.022);
              return (
                <div
                  key={`a-${i}`}
                  style={{
                    ...
                    boxShadow: `0 0 8px ${displayColor}, 0 0 18px ${displayColor}aa`,
                    transform: `rotate(${p.angle}deg) translateY(-${p.r}px)`,
                  }}
                />
              );
            })}
        ...
        {/* ─── ORBIT RING B (counter-clockwise, larger radius) ───────── */}
        {showCoreAndOrbits && (
          <div
            ref={orbitBRef}
            style={{
          ...
          >
            {orbitParticles.b.map((p, i) => {
              const dotSize = Math.max(4, size * 0.016);
              return (
                <div
                  key={`b-${i}`}
                  style={{
                    ...
                    boxShadow: `0 0 6px ${displayColor}, 0 0 14px ${displayColor}88`,
                    transform: `rotate(${p.angle}deg) translateY(-${p.r}px)`,
                  }}
                />
              );
