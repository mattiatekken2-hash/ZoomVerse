...
const RATE_BY_TYPE: Record<PlanetType, number> = {
  BASIC: 2, RARE: 15, EPIC: 80, MYTHIC: 115, NOVA: 122, PLASMA: 130, MUSHROOM: 140, GOLD: 150, V1: 400, V1_NFT: 275,
  ...
  STELLA1: 0, STELLA2: 0, STELLA3: 0, STELLA4: 0,
};
